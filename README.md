...
pixi add libnvjpeg libnvjpeg-dev libnvjpeg-static
# for installing globally
pixi global install libnvjpeg libnvjpeg-dev libnvjpeg-static
```
...
It is possible to list all of the versions of `libnvjpeg` available on your platform:
...
```
pixi search libnvjpeg --channel conda-forge
```
